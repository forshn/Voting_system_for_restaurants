...
public class MealTestData {
    ...
    public static final Meal MEAL_1 = new Meal(MEAL_1_ID, "Тако", 1000,
            LocalDate.of(2021, Month.SEPTEMBER, 8), restaurant1);
    public static final Meal MEAL_2 = new Meal(MEAL_2_ID, "Буррито", 300,
            LocalDate.of(2021, Month.SEPTEMBER, 8), restaurant1);
    public static final Meal MEAL_3 = new Meal(MEAL_3_ID, "Гуакамоле", 400,
            LocalDate.of(2021, Month.SEPTEMBER, 8), restaurant2);
    public static final Meal MEAL_4 = new Meal(MEAL_4_ID, "Стейк из акулы", 180,
            LocalDate.of(2021, Month.SEPTEMBER, 8), restaurant2);
    public static final Meal MEAL_5 = new Meal(MEAL_5_ID, "Мраморная говядина", 150,
            LocalDate.of(2021, Month.SEPTEMBER, 8), restaurant2);
    ...
    public static Meal getNew() {
        return new Meal(null, "New", 1, LocalDate.of(2021, Month.SEPTEMBER, 8), restaurant1);
    }
