...
import static ru.forsh.voting_system_for_restaurants.DishTestData.DISHES_1;
import static ru.forsh.voting_system_for_restaurants.DishTestData.DISHES_2;
...
public class RestaurantTestData {
    ...
    public static final Restaurant restaurant1 = new Restaurant(RESTAURANT_1_ID, "Кафе", DISHES_1);
    public static final Restaurant restaurant2 = new Restaurant(RESTAURANT_2_ID, "Бар", DISHES_2);
    public static final Restaurant restaurant3 = new Restaurant(RESTAURANT_3_ID, "Ресторан", null);

    public static Restaurant getNew() {
        return new Restaurant(null, "NewRest", DISHES_2);
    }

    public static Restaurant getUpdated() {
        Restaurant updated = new Restaurant(restaurant1);
        updated.setName("UpdatedName");
        updated.setDishes(DISHES_2);
        return updated;
    }
}
